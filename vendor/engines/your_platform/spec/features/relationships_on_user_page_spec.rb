...
feature "Relationships on User show view", js: true do
  ...
  pending "adding a relationship and removing it again" do
    ...
    within(first (".section.relationships") ) do
      ...
      page.should have_no_selector( 'a.add_button', visible: true )
      page.should have_no_selector( 'li', visible: true )

    end

  end

  pending "using the auto completion mechanism for selecting a related user"
