...
describe StatusGroup do
  ...
  before do
    ...
    @status_a_1 = @intermediate_group.child_groups.create(name: "Status a 1", type: "StatusGroup")
    @status_a_2 = @intermediate_group.child_groups.create(name: "Status a 2", type: "StatusGroup")
    ...
    @status_b_1 = @corporation_b.child_groups.create(name: "Status b 1", type: "StatusGroup")
    @status_b_2 = @corporation_b.child_groups.create(name: "Status b 2", type: "StatusGroup")
    @status_b_3 = @corporation_b.child_groups.create(name: "Status b 3", type: "StatusGroup")
  ...
  describe "Corporation#status_groups" do
    subject { @corporation_a.status_groups }
  ...
  describe "User#status_groups" do
    ...
    describe "after a promotion" do
      ...
      describe "(with_invalid: true)" do
        subject { @user.status_groups(with_invalid: true) }
        it { should include @status_a_1, @status_a_2 }
      end
    end
