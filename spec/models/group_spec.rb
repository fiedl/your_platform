...
describe Group do
  ...
  describe "(Events)" do
    before do
      ...
      @upcoming_events = [ @group.child_events.create( start_at: 5.hours.from_now ),
                           @subgroup.child_events.create( start_at: 5.hours.from_now ) ]
      @recent_events = [ @group.child_events.create( start_at: 2.days.ago ) ]
