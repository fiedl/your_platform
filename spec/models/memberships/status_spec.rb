  ...
  describe "(status workflow scenario) (bug fix)" do
    ...
    describe "executing the first promotion workflow" do
      ...
      it "should add the second status group to the user's status groups" do
        status_memberships_of_user_and_corporation.should_not include second_status_group_membership
        subject
        status_memberships_of_user_and_corporation.should include second_status_group_membership
      end
      it "should not remove the first status group from the user's status groups" do
        status_memberships_of_user_and_corporation.should include first_status_group_membership
        subject
        status_memberships_of_user_and_corporation.should include first_status_group_membership
      end
    end
