...
feature "Group Members Page" do
  ...
  describe 'when logged in as admin' do
    ...
    # FIXME: Die Funktion ist vorübergehend deaktiviert, da noch nicht
    # sichergestellt ist, dass Benutzer nicht händisch zu einer Gruppe
    # hinzugefügt werden können, für die das nicht gedacht ist:
    #
    #  - Indirekte Status-Gruppen
    #  - Sammel-Gruppen
