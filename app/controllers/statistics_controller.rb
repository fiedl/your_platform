class StatisticsController < ApplicationController
  ...
  def show
    ...
    @list_preset = params[:list] || raise(ActionController::ParameterMissing, 'no list preset given. use parameter "list".')
    ...
    when 'aktivitates_join_and_persist_statistics'
      ...
      raise ActionController::BadRequest, "statistics preset unknown: #{@list_preset}."
    end
