# This is a single-sign-on service copied from a discourse template:
#
...
# Internal Trello:
# 
#   - https://trello.com/c/crBahAM9/962-forum-discourse
#   - https://trello.com/c/WOe8Fr35/983-single-sign-on-sso-2016-queel9ph
#
class SingleSignOn
  ACCESSORS = [:nonce, :name, :username, :email, :avatar_url, 
    :avatar_force_update, :require_activation, :about_me, :external_id, 
    :return_sso_url, :admin, :moderator, :suppress_welcome_message]
  FIXNUMS = []
