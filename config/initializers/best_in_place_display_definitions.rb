...
BestInPlace::DisplayMethods.add_helper_method(Blog, :content, :page_markup)
...
BestInPlace::DisplayMethods.add_helper_method(Page, :teaser_text, :page_markup)
BestInPlace::DisplayMethods.add_helper_method(BlogPost, :teaser_text, :page_markup)
BestInPlace::DisplayMethods.add_helper_method(Pages::ContactForm, :teaser_text, :page_markup)
BestInPlace::DisplayMethods.add_helper_method(Pages::ContentBox, :teaser_text, :page_markup)
BestInPlace::DisplayMethods.add_helper_method(Pages::HomePage, :teaser_text, :page_markup)
