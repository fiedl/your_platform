MyPlatform::Application.configure do
  ...
  config.cache_store = :redis_store, "redis://localhost:6379/0/", { expires_in: 1.week, namespace: "my_platform_#{::STAGE}_cache" }
  ...
  # Do fallback for the moment (true)
  ...
  config.action_mailer.default_url_options = { host: 'demo.your-platform.org', protocol: 'http' }
